...
void* YoloObjectDetector::detectInThread() {
  ...
  chatter_pub = n.advertise<std_msgs::String>("twistexample", 1000);
  ...
  for (i = 0; i < nboxes; ++i) {
	...
	printf("%f %f\n",x_center,y_center);
	printf("%f.0 %f.0\n",x_center*1920,y_center*1080);
  if(x_center<0.33 && y_center<0.33){
    boxnumber=1;
    printf("Drone in Box Number %d\n",boxnumber);}
    else if(x_center>0.33 && x_center<0.66 && y_center<0.33){
    boxnumber=2;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center>0.66 && y_center<0.33){
    boxnumber=3;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center<0.33 && y_center>0.33 && y_center<0.66){
    boxnumber=4;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center>0.33 && x_center<0.66 && y_center>0.33 && y_center<0.66){
    boxnumber=5;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center>0.66 && y_center<0.33  && y_center<0.66){
    boxnumber=6;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center<0.33 && y_center>0.66){
    boxnumber=7;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center>0.33 && x_center<0.66 && y_center>0.66){
    boxnumber=8;
    printf("Drone in Box Number %d\n",boxnumber);}
    else  if(x_center>0.66 && y_center>0.66){
    boxnumber=9;
    printf("Drone in Box Number %d\n",boxnumber);}

      ss << x_center << " " << y_center << " " << boxnumber << " " <<BoundingBox_width*BoundingBox_height;
	      msg.data = ss.str();
